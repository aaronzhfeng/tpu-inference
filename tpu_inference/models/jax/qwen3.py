...
class Qwen3Model(Qwen2Model):
    ...
    def __init__(self,
        ...
        # Auxiliary hidden-state layers for speculative decoding (Eagle3, DFlash)
        self._init_aux_hidden_state_layers(vllm_config)

    def _init_aux_hidden_state_layers(self, vllm_config):
        """Configure which layers to capture for speculative decoding."""
        ...
        if vllm_config.speculative_config:
            ...
            if method == "eagle3":
                ...
                dflash_cfg = getattr(draft_config.hf_config,
                                     "dflash_config", {})
